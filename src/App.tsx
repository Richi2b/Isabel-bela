...
export default function App() {
  ...
  return (
    <div className="bg-[#0a0a0a] text-zinc-100 min-h-screen flex flex-col font-sans selection:bg-green-500 selection:text-black">
      
      {/* 1. Header Navigation */}
      <header className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-12 py-6 border-b border-zinc-800 bg-[#0f0f0f] gap-4" id="header-nav">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-green-500 rounded-sm flex items-center justify-center shadow-lg shadow-green-500/10">
          ...
          <span className="text-lg font-black tracking-widest uppercase font-display">
            DIRECTO AO PONTO <span className="text-green-500">ANGOLA</span>
          </span>
        </div>
        
        <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs font-bold uppercase tracking-widest text-[#00ff66] justify-center">
        ...
        <a 
          ...
          className="px-5 py-2 w-full lg:w-auto text-center bg-zinc-100 text-black text-xs font-bold uppercase tracking-widest hover:bg-green-500 transition-colors"
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-zinc-800" id="hero-showcase">
        {/* Left Hero */}
        <div className="lg:col-span-7 bg-[#0a0a0a] p-8 md:p-12 flex flex-col justify-center">
          <span className="text-green-500 font-mono text-xs mb-3 tracking-widest uppercase block">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full border-2 border-black bg-emerald-700 flex items-center justify-center font-bold text-xs text-white">L</div>
              <div className="w-10 h-10 rounded-full border-2 border-black bg-indigo-800 flex items-center justify-center font-bold text-xs text-white">B</div>
              <div className="w-10 h-10 rounded-full border-2 border-black bg-zinc-800 flex items-center justify-center font-bold text-xs text-white">C</div>
            </div>
        ...
        <div className="lg:col-span-5 bg-[#0f0f0f] p-8 md:p-12 flex flex-col justify-between border-t lg:border-t-0 lg:border-l border-zinc-805">
          <div className="space-y-6">
            <span className="text-3xs font-mono font-bold uppercase tracking-widest text-zinc-500 block">
              [ Caso Real: Climatização & Bazar ]
            </span>
            
            <div className="space-y-4">
              <div className="bg-zinc-900 border border-zinc-850 p-5 relative overflow-hidden">
                <div className="absolute right-4 top-4 bg-green-500/10 text-green-400 border border-green-500/25 px-2 py-0.5 text-4xs font-mono font-bold uppercase tracking-wider">
                  Testado
                </div>
                <div className="text-xs uppercase font-mono tracking-wider text-zinc-500 flex items-center gap-1.5 mb-1">
                  <Building className="h-3.5 w-3.5 text-green-500" /> Imobiliária & AC em Talatona
                </div>
              ...
              <div className="bg-zinc-900 border border-zinc-850 p-5">
                <div className="text-xs uppercase font-mono tracking-wider text-zinc-500 flex items-center gap-1.5 mb-1">
                  <DollarSign className="h-3.5 w-3.5 text-[#00ff66]" /> Custo por conversa real
                </div>
              ...
              <div className="bg-zinc-900 border border-zinc-850 p-5">
                <div className="text-xs uppercase font-mono tracking-wider text-zinc-500 flex items-center gap-1.5 mb-1">
                  <Flame className="h-3.5 w-3.5 text-green-500" /> Canal Preferido
                </div>
          ...
          <div className="mt-8 border-t border-zinc-900 pt-6">
            <span className="text-xs font-mono uppercase tracking-widest text-zinc-500 block mb-3">Estratégias Chave em Angola:</span>
      ...
      <div className="max-w-7xl mx-auto w-full px-6 lg:px-12 py-12 space-y-12 flex-1">
        ...
        <div className="bg-zinc-950 border border-zinc-800 p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-4 font-mono text-3xs font-bold uppercase text-zinc-400 self-stretch md:self-auto justify-between md:justify-start">
            <div className="bg-[#111] px-3 py-2 border border-zinc-800 text-center">
              <span>AOV Médio</span>
              <p className="text-green-400 font-bold block mt-0.5">{selectedPreset.typicalAOV.toLocaleString()} Kz</p>
            </div>
            <div className="bg-[#111] px-3 py-2 border border-zinc-800 text-center">
              <span>CPC Est.</span>
              <p className="text-green-400 font-bold block mt-0.5">{selectedPreset.typicalCPC} Kz</p>
            </div>
            <div className="bg-[#111] px-3 py-2 border border-zinc-800 text-center">
              <span>Conversão</span>
              <p className="text-[#00ff66] font-bold block mt-0.5">{selectedPreset.typicalCloseRate}%</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end">
            <div>
              <span className="text-3xs uppercase font-mono tracking-widest text-green-500 font-bold">[ Passo 01]</span>
        ...
        <div className="space-y-4 pt-4">
          <div>
            <span className="text-3xs uppercase font-mono tracking-widest text-[#00ff66] font-bold">[ Passo 02 ]</span>
            <h2 className="text-xl md:text-2xl font-black font-display uppercase tracking-tight text-white mt-1">
        ...
        <div className="space-y-4 pt-4">
          <div>
            <span className="text-3xs uppercase font-mono tracking-widest text-[#00ff66] font-bold">[ Passo 03 ]</span>
            <h2 className="text-xl md:text-2xl font-black font-display uppercase tracking-tight text-white mt-1">
        ...
        <div className="space-y-4 pt-4">
          <div>
            <span className="text-3xs uppercase font-mono tracking-widest text-[#00ff66] font-bold">[ Passo 04 ]</span>
            <h2 className="text-xl md:text-2xl font-black font-display uppercase tracking-tight text-white mt-1">
      ...
      <footer className="bg-green-500 text-black py-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6 mt-12 border-t-2 border-white/10 shadow-2xl">
        <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-10 w-full md:w-auto">
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <span className="text-[10px] uppercase font-bold tracking-tighter text-black/70">
